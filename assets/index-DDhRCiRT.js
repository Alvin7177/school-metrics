  ...
  `),z(g)}function Fn(){const e=V();g.innerHTML=B(`
    <div class="stack-screen">
      ...
      <div class="login-form profile-form">
        ...
        <label class="field">
          <span>학번 (4자리)</span>
          <input type="text" id="profile-sid" value="${W((e==null?void 0:e.studentId)||"")}" inputmode="numeric" maxlength="4" placeholder="1413" />
        </label>
